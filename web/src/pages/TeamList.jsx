...
const TeamList = () => {
  ...
  return (
    <div className="min-h-full py-26 px-4">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <h1 className="text-5xl lg:text-8xl sujoy font-bold text-black mb-4">
            Meet Our Team
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamData.map((member) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-4">
                  <h2 className="text-5xl md:text-6xl lg:text-6xl sujoy font-bold text-gray-800 mb-1">
                    {member.name}
                  </h2>
